...
export default function LoginForm() {
  ...
  return (
    <div className='max-w-[460px] w-full px-11 py-9 bg-[#fff] rounded-[24px] flex flex-col mx-auto'>
      <h3 className='text-[#000] text-sm font-normal'>WELCOME BACK</h3>
      <h2 className='text-[#000] text-2xl font-semibold mb-7'>Log In to your Account</h2>
