      ...
      <div className="bg-white rounded-b-lg shadow-lg p-6 space-y-6">
        {
          stage === "direction" ? ( 
          <div className="mb-8">
            <h2 className="text-3xl font-bold mb-4 w-full text-center block">Question 3-4: Describe a picture</h2>
            <h3 className="text-lg font-semibold mb-4">Direction:</h3>
            <p className="text-gray-700">
              In this part of the test, you will describe the picture on the
              screen. You will have 45 seconds to prepare your response. Then you
              will have 30 seconds to describe the picture.
            </p>
