...
const testData = {
  ...
  questions: [
    ...
    {
      question_id: "653f1af74b8f1e2f10123457",
      question_text: "What is the man doing?",
      question_image: "https://example.com/images/part1_q1.png",
      choices: [
      ...
      correct_answer: 1,
      explain_answer: "The man is holding a phone to his ear.",
      part: 1
    },
    ...
    {
      question_id: "653f1b274b8f1e2f10123458",
      question_text: "Where did you leave the report?",
      choices: [
        "A. On the desk.",
        "B. It's due tomorrow.",
        "C. I will report it."
      ...
      correct_answer: 1,
      explain_answer: "The correct answer is about location, not timing.",
      part: 2
    },
    ...
    {
      question_id: "653f1b564b8f1e2f10123459",
      ...
      correct_answer: 3,
      explain_answer: "The woman's tone suggests she needs more time.",
      part: 3
    },
    {
        question_id: "653f1b564b8f1e2f10123459",
        question_text: "What does the woman say?",
        choices: [
          "A. She forgot to bring something.",
          "B. She is late for a meeting.",
          "C. She needs more time."
      ...
      {
        question_id: "653f1b564b8f1e2f10123459",
        question_text: "What does the woman asdmas;md?",
        choices: [
          "A. She forgot to bring something.",
          "B. She is late for a meeting.",
          "C. She needs more time."
    ...
    {
      question_id: "653f1b7d4b8f1e2f10123460",
      question_text: "Who is the intended audience?",
      choices: [
        "A. College students.",
      ...
      correct_answer: 2,
      explain_answer: "The speaker mentions business meetings and conferences.",
      part: 4
    },
    {
        question_id: "653f1b7d4b8f1e2f10123460",
    ...
    {
      question_id: "653f1bb34b8f1e2f10123461",
      question_text: "The report will be submitted _______ Friday.",
      choices: [
        "A. on",
        "B. in",
        "C. at",
      ...
      correct_answer: 1,
      explain_answer: "'On' is the correct preposition for days of the week.",
      part: 5
    },
    ...
    {
      strImg: "https://example.com/images/part6_passage.png",
      passage: `This truck is 3 years old and in excellent condition for its age. With less than 15z000 miles on the odometer, it has had quite an easy life transporting animals for an animal sanctuary, and it has been used by only one very careful owner.This vehicle averages around 18 miles per gallon on the highway and 13 miles per gallon in the city, which makes its fuel efficiency quite competitive. Price reduced for quick sale to $19,000 (or nearest offer).
      ...
      question_id: "653f1bd84b8f1e2f10123462",
      question_text: "Which word best completes the sentence in the passage?",
      choices: [
        "A. Although",
        "B. Since",
        "C. Despite",
      ...
      correct_answer: 2,
      explain_answer: "'Since' is the best choice for a cause-effect relationship.",
      part: 6
    },
    {
      question_id: "653f1c0d4b8f1e2f10123463",
      question_text: "What is the purpose of the passage?",
      choices: [
      ...
      correct_answer: 4,
      explain_answer: "The passage gives detailed instructions on how to use a product.",
      part: 6
    },
    {
        question_id: "653f1c0d4b8f1e2f10123463",
    ...
    {
      question_id: "653f1c3a4b8f1e2f10123465",
      question_text: "What is the purpose of the email?",
      question_image: "https://example.com/images/part7_email.png",
      choices: [
      ...
      correct_answer: 2,
      explain_answer: "The email contains details about a hotel reservation confirmation.",
      part: 7
    },
    {
        strImg: "https://example.com/images/part6_passage.png",
